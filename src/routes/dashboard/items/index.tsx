        ...
        <EmptyHeader>
          ...
          <EmptyDescription>
            {items.length === 0
              ...
              : 'Not items match your current search filters'}
          </EmptyDescription>
        </EmptyHeader>
        {items.length === 0 && (
          <EmptyContent>
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      {filteredItems.map((item) => (
        <Card
          key={item.id}
          className="group overflow-hidden transition-all shadow-lg pt-0"
        >
          <Link
          ...
          >
            <div className="aspect-video w-full overflow-hidden bg-muted">
              <img
                ...
                src={
                  item.ogImage ??
                  'https://imgs.search.brave.com/UCaF9nIwN3WJMegDQtcFhpRoN41dfc8_wvyMfo1ohMU/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvMjE2/MzY3NTcyNi9waG90/by9jb2xvcmZ1bC1n/cmFkaWVudC1ibHVy/cmVkLWJhY2tncm91/bmQud2VicD9hPTEm/Yj0xJnM9NjEyeDYx/MiZ3PTAmaz0yMCZj/PWNBNEY1akZiM3RT/elRnYzdUdk0tTEJR/WmlnamE1ak1rSldk/c1o0Zk9xRjA9'
                }
